...
void shell_sort(std::vector<int>& in, bool(*compare)(int, int))
{
...
std::vector<int> merge(std::vector<int> a, std::vector<int> b, bool(*compare)(int, int))
{
    int i = 0, j = 0;
    std::vector<int> res;
...
void shell_sort_simple_merge(std::vector<int>& in, int parts, bool(*compare)(int, int))
{
